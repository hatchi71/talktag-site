  ...
  if (isHome) {
    ...
    if (home && !home.classList.contains('mission-home')) {
      ...
      style.textContent = `
        ...
        .topbar{height:96px;padding:0 28px}.top-brand{gap:14px}.top-brand>a{position:relative;display:block;width:72px;height:72px;flex:0 0 72px;overflow:hidden;border-radius:50%;background:#fff}.mobile-logo{display:block!important;position:absolute;left:50%;top:-18px;width:174px!important;height:auto!important;max-width:none;transform:translateX(-50%)}.catchphrase{font-size:22px;line-height:1.08;white-space:normal;max-width:310px}.crumb{font-size:12px}.sidebar>a:first-child{display:none}.side-logo{display:none!important}.nav{margin-top:4px}
        ...
        @media(max-width:820px){
          .topbar{height:88px;padding:0 12px}.top-brand{gap:10px}.top-brand>a{width:64px;height:64px;flex-basis:64px}.mobile-logo{top:-16px;width:155px!important}.catchphrase{font-size:15px;line-height:1.12;max-width:210px}.view{min-height:calc(100dvh - 160px)}
          ...
          .floating-share{position:fixed;right:14px;top:102px;width:50px;height:50px;border-radius:16px}.floating-language{position:fixed;right:74px;top:100px;width:54px;height:54px;border-radius:18px}.floating-language svg{width:29px;height:29px}.language-menu{position:fixed;right:74px;top:162px;width:224px}.share-menu{position:fixed;right:14px;top:160px;width:184px}.share-toast{position:fixed;right:14px;top:364px;max-width:calc(100vw - 28px)}
