    ...
    if (home && !home.classList.contains('mission-home')) {
      ...
      style.textContent = `
        ...
        @media(max-width:820px){
          ...
          .home-news{position:relative;left:auto;right:auto;top:auto;display:grid;grid-template-columns:1fr;gap:14px;margin-top:-20px;padding-bottom:40px}.feature-card{min-height:0;padding:20px 21px;border-radius:20px}.feature-card h3{font-size:27px;font-weight:950}.feature-card p{font-size:12px}
        }
      `;
