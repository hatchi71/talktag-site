  ...
  if (isHome) {
    ...
    if (home && !home.classList.contains('mission-home')) {
      ...
      style.textContent = `
        ...
        .feature-card small{font-size:10px;font-weight:900;letter-spacing:.15em;color:#8499bd}.feature-card h3{font-size:25px;line-height:1.04;letter-spacing:-.035em;color:#082b68;margin:12px 0}.feature-card p{font-size:13px;line-height:1.45;color:#617797;margin:0 0 14px}.feature-card strong{font-size:11px;color:#1768e9;letter-spacing:.04em}
        @media(max-width:820px){
          ...
          .home-news{position:relative;left:auto;right:auto;top:auto;display:grid;grid-template-columns:1fr;gap:14px;margin-top:-20px;padding-bottom:40px}.feature-card{min-height:0;padding:20px 21px;border-radius:20px}.feature-card h3{font-size:22px}.feature-card p{font-size:12px}
        }
      `;
